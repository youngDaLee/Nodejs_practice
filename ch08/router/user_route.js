var database;
var UserModel;
var init = function(db, um){
	database = db;
	UserModel = um;

}

var adduser_post = function(req, res) {
...
var listuser_post = function(req, res) {
...
module.exports.login = login_post;
module.exports.adduser = adduser_post;
module.exports.listuser = listuser_post;
